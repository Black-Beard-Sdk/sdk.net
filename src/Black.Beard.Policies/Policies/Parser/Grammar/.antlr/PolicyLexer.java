...
public class PolicyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IN", "NOT_IN", "ALIAS", "POLICY", "INCLUDE", "STRING", "INT", "ID", 
			"IDQUOTED", "ESC", "SAFECODEPOINT", "UNICODE", "HEX", "MULTI_LINE_COMMENT", 
			"LineComment"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "ID", "IDQUOTED", "MULTI_LINE_COMMENT", "LineComment"
		};
	}
